...
pendown()
write("¡No hay un día especial para celebrar, con tenerte todos los dias", align="center", font=("Arial", 16, "italic"))  # Segunda línea

penup()
goto(0, -310)  # Ajusta para el segundo párrafo
pendown()
write("son especiales. Madre mía Que Dios te bendiga y te proteja siempre!", align="center", font=("Arial", 16, "italic"))  # Segunda línea
